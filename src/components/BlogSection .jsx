                ...
                <div className="blog-content">
                  <div className="post-meta">
                    <span className="p-relative">
                      <a className='linked' href={blog.link}> < RiAdminFill / > By {blog.author}</a>
                    </span>
                    <span className="p-relative">
                      <a className='linked' href={blog.link}><FaCalendarAlt />
                      {blog.date}</a>
                    </span>
                  </div>
                  <hr />
                  <h5 className="blog-title mb-30">
                    <a className='linked' href={blog.link}>{blog.title}</a>
                  </h5>
